        ...
        <div className="relative z-10 w-full max-w-[420px]">
          <div className="auth-card auth-fade-up auth-delay-100 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-[0_8px_40px_rgb(0,0,0,0.06)] dark:shadow-[0_8px_40px_rgb(0,0,0,0.3)] border border-white/60 dark:border-gray-800 p-8 sm:p-10">
            ...
            <div className="text-center mb-8 auth-fade-up auth-delay-300">
              <h2 className="text-2xl font-bold text-[#111827] dark:text-white tracking-tight">Welcome back</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1.5">Sign in to continue your preparation</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="flex justify-end auth-fade-up auth-delay-600">
                <Link
                  href="/register"
                  className="text-xs font-medium text-[#2563EB] dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
            ...
            {/* Sign up link */}
            <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6 auth-fade-up auth-delay-800">
