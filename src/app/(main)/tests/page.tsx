...
const topicCards: TopicCardConfig[] = [
  ...
  {
    topic: "ER Model, Entities, Attributes, Relationships",
    title: "ER Modeling Challenge",
    description: "Master ER Diagrams — Entities, Attributes (Multivalued, Derived), Relationships (1:N, M:N) & Weak Entities",
    icon: Database,
    defaultSection: "System IT",
    difficultyLabel: "Intermediate to Hard",
    buttonLabel: "Take Challenge",
    colors: {
      card: "border-cyan-200 bg-gradient-to-r from-cyan-50 via-teal-50 to-emerald-50 dark:from-cyan-950/30 dark:via-teal-950/20 dark:to-emerald-950/20 dark:border-cyan-800",
      circle1: "bg-cyan-100/40 dark:bg-cyan-900/10",
      circle2: "bg-teal-100/40 dark:bg-teal-900/10",
      iconBg: "bg-cyan-100 dark:bg-cyan-900/40",
      iconColor: "text-cyan-600 dark:text-cyan-400",
    ...
    skeleton: ["border-cyan-200 dark:border-cyan-800", "from-cyan-50 dark:from-cyan-950/30", "via-teal-50 dark:via-teal-950/20", "to-emerald-50 dark:to-emerald-950/20", "bg-cyan-200/60 dark:bg-cyan-800/40"],
  },
  {
    topic: "Relational Model, Keys, Relational Algebra",
    title: "DBMS & Relational Algebra",
    description: "Master Relational Model, Keys (Primary, Foreign, Candidate), and Relational Algebra operations.",
    icon: Database,
    defaultSection: "System IT",
    difficultyLabel: "Intermediate to Advanced",
    buttonLabel: "Start Practice",
    colors: {
      card: "border-indigo-200 bg-gradient-to-r from-indigo-50 via-blue-50 to-slate-50 dark:from-indigo-950/30 dark:via-blue-950/20 dark:to-slate-950/20 dark:border-indigo-800",
      circle1: "bg-indigo-100/40 dark:bg-indigo-900/10",
      circle2: "bg-blue-100/40 dark:bg-blue-900/10",
      iconBg: "bg-indigo-100 dark:bg-indigo-900/40",
      iconColor: "text-indigo-600 dark:text-indigo-400",
    ...
    skeleton: ["border-indigo-200 dark:border-indigo-800", "from-indigo-50 dark:from-indigo-950/30", "via-blue-50 dark:via-blue-950/20", "to-slate-50 dark:to-slate-950/20", "bg-indigo-200/60 dark:bg-indigo-800/40"],
  },
];
